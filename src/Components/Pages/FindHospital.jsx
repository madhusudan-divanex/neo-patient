...
function FindHospital() {
    ...
    async function fetchHospitals() {
        const result = await getApiData(`api/hospital?page=${currentPage}&limit=12&name=${name}`)
        if (result.success) {
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <h4 className="lg_title">Find Hospital</h4>
                            </div> 
                                            ...
                                            <div className="lab-technology-card">
                                                <div className="doctor-mega-card">
                                                    <div className="doctor-pic-bx">
                                                        <img src={item?.logo ?
                                                            `${base_url}/${item?.logo}` : "/hospital-pic.jpg"} alt="" />
                                                    </div>
                                                        ...
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <button className="heart-btn" onClick={() => handleFavorite(item?.userId)}>
                                                                    {favIds?.some(fav => fav?.hospitalId === item?.userId) ?
