...
function CatPharmacy() {
    ...
    async function fetchPharmacy() {
        const result = await getApiData(`patient/category/top-users?catType=pharmacy&catId=${id}`)
        if (result.success) {
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <h4 className="lg_title">Find {name} Pharmacy</h4>
                            </div>
                                                ...
                                                <div className="doctor-mega-card">
                                                    ...
                                                    <div className="doctor-details  flex-grow-1">
                                                        ...
                                                        <div className="  d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <Link to={`/pharmacy-detail/${item?.userID?.name}/${item?.userId?._id}`} className="nw-thm-btn">View Details</Link>
                                                            </div>
                                                            <div>
                                                                <button className="heart-btn" onClick={() => handleFavorite(item?.userId?._id)}>
                                                                    {favIds?.some(fav => fav?.pharId === item?.userId?._id) ?
