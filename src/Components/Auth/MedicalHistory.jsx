...
function MedicalHistory() {
   ...
   const handleChange = (e) => {
    ...
    const validate = () => {
        ...
        if (!formData?.chronicCondition?.trim())
            temp.chronicCondition = "Chronic condition is required";
        if (!formData?.medicationDetail?.trim())
            temp.medicationDetail = "Medication details is required";
        if (!formData?.allergies?.trim())
            temp.allergies = "Allergies is required";
                            ...
                            <div className="nw-form-container">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="custom-frm-bx">
                                        ...
                                        {errors.chronicCondition && <small className="text-danger">{errors.chronicCondition}</small>}
                                    </div>
                                    ...
                                    <div className="custom-frm-bx">
                                        ...
                                        />
                                        {errors.medicationDetail && <small className="text-danger">{errors.medicationDetail}</small>}
                                    </div>
                                    ...
                                    <div className="custom-frm-bx">
                                        ...
                                        <textarea
                                            ...
                                            className="form-control new-control-frm"
                                        />
                                        {errors.allergies && <small className="text-danger">{errors.allergies}</small>}
                                    </div>
